...
def main(args=None):
    ...
    dataset_path = '/home/samuel/dev/environment_modeling/ROSBAGS/iisy_random_motion_data_Inverted'
    joint_positions_path = dataset_path + '/joint_data/joint_positions.txt'
    pose_file_path = dataset_path + '/pose_data.txt'
