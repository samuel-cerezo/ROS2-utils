...
gnome-terminal -- bash -c "ros2 launch realsense2_camera rs_launch_get_params_from_yaml.py config_file:=/home/samuel/dev/environment_modeling/scripts/KUKA/dataset_record/config_sara.yaml; exec bash"
